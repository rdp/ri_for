Gem::Specification.new do |s|
  ...
  s.files = ["lib/method_describer.rb", "lib/method_describer/class_desc.rb", "lib/method_describer/kernel_new_methods_list.rb", "lib/method_describer/method_desc.rb"]
  s.require_paths = ['lib']
